...
import iconSearch from '../assets/images/nav_icons/search.svg';
import iconSearchActive from '../assets/images/nav_icons/search_active.svg';
  ...
  return (
    <nav className="navigation" onClick={vibrate}>
      ...
      >
        {({ isActive }) => (
          <>
            <img src={isActive ? iconGroupActive : iconGroup} height="30" alt="Ubersicht" />
            <span>Lernorte</span>
          </>
        )}
      </NavLink>
      ...
      >
        {({ isActive }) => (
          <>
            <img src={isActive ? iconSearchActive : iconSearch} height="30" alt="lernorte" />
            <span>Suche</span>
          </>
        )}
      </NavLink>
